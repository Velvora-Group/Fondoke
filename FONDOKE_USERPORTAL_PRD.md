...
This Product Requirements Document (PRD) defines the complete specification for Fondoke, a revolutionary hotel booking and reselling platform. The document has been organized into focused sections for easier navigation and maintenance.

**What is Fondoke?**  
Fondoke is a hotel booking and reselling platform that enables users to book hotels from multiple platforms, sell their unused reservations to other users, and trade hotel reservations in a dynamic marketplace. The platform combines traditional booking functionality with a fintech-style trading system, providing flexibility and cost savings for travelers while creating a secondary market for hotel reservations.

---

## 📚 Table of Contents

This PRD is organized into 13 comprehensive sections. Click any section below to view detailed documentation:
...
- Hotel Search & Discovery (AI-powered + manual)
- Hotel Details Page
- Booking & Payment
- Trading Marketplace
...
- **Section Documents:** 13 detailed documents in the `/docs` folder
